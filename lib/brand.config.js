...
export const brand = {
  ...
  coins: [
    ...
    { sym: "DOGE", name: "Dogecoin", binance: "dogeusdt", tv: "BINANCE:DOGEUSDT", color: "#c2a633", dec: 5, qdec: 0 },
    { sym: "LINK", name: "Chainlink", binance: "linkusdt", tv: "BINANCE:LINKUSDT", color: "#2a5ada", dec: 3, qdec: 2 },
    { sym: "AVAX", name: "Avalanche", binance: "avaxusdt", tv: "BINANCE:AVAXUSDT", color: "#e84142", dec: 3, qdec: 2 },
    { sym: "DOT", name: "Polkadot", binance: "dotusdt", tv: "BINANCE:DOTUSDT", color: "#e6007a", dec: 4, qdec: 1 },
    { sym: "TRX", name: "TRON", binance: "trxusdt", tv: "BINANCE:TRXUSDT", color: "#eb0029", dec: 5, qdec: 0 },
    { sym: "TON", name: "Toncoin", binance: "tonusdt", tv: "BINANCE:TONUSDT", color: "#0098ea", dec: 4, qdec: 1 },
    { sym: "LTC", name: "Litecoin", binance: "ltcusdt", tv: "BINANCE:LTCUSDT", color: "#8a8a8a", dec: 2, qdec: 2 },
    { sym: "NEAR", name: "NEAR", binance: "nearusdt", tv: "BINANCE:NEARUSDT", color: "#00ec97", dec: 4, qdec: 1 },
    { sym: "APT", name: "Aptos", binance: "aptusdt", tv: "BINANCE:APTUSDT", color: "#4ce0b3", dec: 4, qdec: 1 },
    { sym: "SUI", name: "Sui", binance: "suiusdt", tv: "BINANCE:SUIUSDT", color: "#4da2ff", dec: 4, qdec: 1 },
    { sym: "ARB", name: "Arbitrum", binance: "arbusdt", tv: "BINANCE:ARBUSDT", color: "#12aaff", dec: 4, qdec: 1 },
    { sym: "AAVE", name: "Aave", binance: "aaveusdt", tv: "BINANCE:AAVEUSDT", color: "#b6509e", dec: 2, qdec: 2 },
  ],
  ...
  paperCashUSDT: 500,   // 데모 페이퍼트레이딩 초기 잔고 (고정 $500)
  feeRate: 0.00015,     // 거래 수수료 0.015%
};
